...
What if now we a variable to represent that index number:
...
for(number in disordered_vector){
  print(number)
}
```
...
peak_location = data.frame(seqnames = "chr1", start = 114567557, end = 114581629, strand = "-", signal = "5.6")
